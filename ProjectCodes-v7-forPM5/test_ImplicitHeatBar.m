...
if size(X_BE_FD)==size(X_BE_an),
   difference_BE_J_an_FD=norm(X_BE_FD-X_BE_an)
end

% compare to Forward Euler
[X_FE] = ForwardEuler(eval_f,x_start,p,eval_u,t_start,t_stop*0.99/10,max_dt_FE,visualize);
