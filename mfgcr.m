function [x, r_norms] = mfgcr(fname, xk, t, b, tol, epsilon, maxiters)
...
% search direction and multiply by M
  p(:,iter) = r;
  Mp(:, iter) = (fname(xk+epsilon*p(:,iter),t) - f0)/epsilon; % approximate product J*dx with finite difference
